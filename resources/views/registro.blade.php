...
<div class="container register " style="background: rgba(48, 164, 68, 0.8);">
    <div class="row">
        ...
        <div class="col-md-9 register-right" style="background: rgba(48, 164, 68, 0.8);">
            ...
            <div class="tab-content" id="myTabContent" >
                <div class="tab-pane fade show active"
                    ...
                    <h3 class="register-heading text-light" >SkillSwap te espera el primer paso es registrarse</h3>
